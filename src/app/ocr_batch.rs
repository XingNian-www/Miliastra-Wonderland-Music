...
#[derive(Clone, Debug)]
pub(super) struct OcrImageBlock<Id> {
    pub(super) id: Id,
    pub(super) rect: Rect,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(super) struct OcrBlockText<Id> {
    pub(super) id: Id,
    pub(super) text: String,
}

pub(super) fn batch_recognize_blocks<Id: Clone>(
...
mod tests {
    use super::*;
    use crate::app::ocr_runtime::{OcrDevice, OcrPriority, OcrRuntime};
